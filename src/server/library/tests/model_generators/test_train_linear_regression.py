...
class TestTrainLinearRegression:
    ...
    def test_train_linear_regression_ols_iris_data(self, iris_data):
        config = {
            "classifier": "Linear Regression",
            "validation_method": "Recall",
            "optimizer": "Ordinary Least Squares",
            "label_column": "label",
        }
        ...
        results = model_generator._test(iris_data)

        assert results["mean_squared_error"]["average"] < 0.3

    def test_train_linear_regression_ols_2k_fv(self, feature_vectors_2k):
        config = {
            "classifier": "Linear Regression",
            "validation_method": "Recall",
            "optimizer": "Ordinary Least Squares",
        ...
        results = model_generator._test(feature_vectors_2k)

        assert results["mean_squared_error"]["average"] < 0.3

    def test_train_linear_regression_l1_lasso_iris_data(self, iris_data):
        config = {
            "classifier": "Linear Regression",
            "validation_method": "Recall",
            "optimizer": "L1 Lasso",
    ...
    def test_train_linear_regression_l1_lasso_2k_fv(self, feature_vectors_2k):
        config = {
            "classifier": "Linear Regression",
            "validation_method": "Recall",
            "optimizer": "L1 Lasso",
    ...
    def test_train_linear_regression_l2_ridge_iris_data(self, iris_data):
        config = {
            "classifier": "Linear Regression",
            "validation_method": "Recall",
            "optimizer": "L2 Ridge",
    ...
    def test_train_linear_regression_l2_ridge_2k_fv(self, feature_vectors_2k):
        config = {
            "classifier": "Linear Regression",
            "validation_method": "Recall",
            "optimizer": "L2 Ridge",
