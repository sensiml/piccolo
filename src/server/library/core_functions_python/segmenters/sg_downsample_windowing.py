...
def tr_downsample_windowing(
    input_data, group_columns, num_windows=5, return_segment_index=False
):
    """
...
tr_downsample_windowing_contracts = {
    "input_contract": [
        {"name": "input_data", "type": "DataFrame"},
        {"name": "group_columns", "type": "list", "element_type": "str"},
        {"name": "num_windows", "type": "int", "default": 5, "c_param": 1},
        {
