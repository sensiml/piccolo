...
} from "store/featureAnalysis/actions";

import TheFeatureEmbedding from "./TheFeatureEmbedding";

const mapStateToProps = (state) => {
  return {
    modelData: state.models.modelData?.data,
    segments: selectSegments(state),
    labelColorHashMap: selectLabelValuesColors("Label")(state),
...
export default connect(mapStateToProps, mapDispatchToProps)(TheFeatureEmbedding);
