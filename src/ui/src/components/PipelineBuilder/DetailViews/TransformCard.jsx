...
export default function TransformCard({ pipeline, transforms }) {
      ...
      <CardContent>
        <Grid container spacing={1}>
          ...
          {transform ? (
            <>
              <Grid item xs={3}>
                <Typography className={classes.title}>SubType:</Typography>
              </Grid>
              <Grid item xs={8}>
                <Typography className={classes.pos}>{transform.subtype}</Typography>
              </Grid>
              <Grid item xs={1} />
            </>
          ) : null}
