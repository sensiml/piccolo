...
class UtilsBufferMedianTest : public testing::Test
{
...
TEST_F(UtilsBufferMedianTest, median_test)
{
    {
        int ret;
        int base_index = 0;
        ...
        ret = buffer_median(pringb, base_index, length);
        ASSERT_EQ(4, ret);
...
TEST_F(UtilsBufferMedianTest, median_test_head_tail_offset)
{
    {
        ringb *pringb = rb + 1;
        int base_index = 0;
