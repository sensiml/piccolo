...
{
#define FG_TIME_ABS_PCT_TIME_OVER_THRESHOLD_NUM_PARAMS 1
#define FG_TIME_ABS_PCT_TIME_OVER_THRESHOLD_THRESHOLD_PARAM_IDX 0
	...
	int32_t threshold = (int32_t)params->data[FG_TIME_ABS_PCT_TIME_OVER_THRESHOLD_THRESHOLD_PARAM_IDX];
	ringb *rb;
	int16_t val;
	int32_t start_index;
