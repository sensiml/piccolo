...
{
#define FG_SHAPE_DIFFERENCE_HIGH_FREQUENCY_NUM_PARAMS 1
#define FG_SHAPE_DIFFERENCE_HIGH_FREQUENCY_SMOOTHING_FACTOR_PARAM_IDX 0
	int32_t icol;
	FLOAT firsthalf, secondhalf;
	int32_t sf = (int32_t)params->data[FG_SHAPE_DIFFERENCE_HIGH_FREQUENCY_SMOOTHING_FACTOR_PARAM_IDX];
