...
{
#define SG_FILTER_ENERGY_THRESHOLD_NUM_PARAMS 5
#define THRESHOLD_UPPER_PARAM_IDX 0
#define THRESHOLD_LOWER_PARAM_IDX 1
#define RATIOLIMIT_PARAM_IDX 2
#define BACKOFF_PARAM_IDX 3
#define DELAY_PARAM_IDX 4
    ...
    int32_t threshold_upper = (int32_t)params->data[THRESHOLD_UPPER_PARAM_IDX];
    int32_t threshold_lower = (int32_t)params->data[THRESHOLD_LOWER_PARAM_IDX];
    float_t ratio_limit = (float_t)params->data[RATIOLIMIT_PARAM_IDX];
    ...
    pass_threshold = buffer_pass_threshold_peak_ratio(rb, base_index, 0, kb_model->sg_length, threshold_upper, threshold_lower, ratio_limit);
